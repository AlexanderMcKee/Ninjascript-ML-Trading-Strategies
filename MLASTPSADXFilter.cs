...
{
    public class MLASTPSADXFilter : Strategy
    {
        private ATR atr;
        private ADX adx;
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description = "ML Adaptive SuperTrend - Pure Signals with ADX filter (separate)";
                Name = "MLASTPSADXFilter";
        ...
        protected override void OnBarUpdate()
        {
            ...
            if (CurrentBar < Math.Max(TrainingPeriod, ADXLength)) return;
        ...
        [NinjaScriptProperty]
        [Display(Name="ADX Length", GroupName="4. Filters")]
        public int ADXLength { get; set; }

        [NinjaScriptProperty]
        [Display(Name="ADX Threshold", GroupName="4. Filters")]
        public int ADXThreshold { get; set; }

        [NinjaScriptProperty]
        [Display(Name="ADX Hold Bars", GroupName="4. Filters")]
